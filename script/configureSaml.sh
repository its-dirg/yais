...
then
  ...
  spConfFile="$pysaml2Path/example/sp-repoze/sp_conf.py"
  spMetadataFile="$pysaml2Path/example/sp-repoze/sp_conf.xml"
  touch $spMetadataFile
  touch $idpMetadataFile
  echo "IdP setup"
  ...
  cd "$pysaml2Path/example/sp-repoze"
